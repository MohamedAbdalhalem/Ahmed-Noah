  ...
  return (
    <div className="relative">
      <nav className="flex  backdrop-blur-xl justify-between items-center px-7 2xl:px-40 py-4 fixed w-full z-50">
        <a href="#home" className="text-3xl  cursor-pointer font-bold dark:text-white">&lt;AN /&gt;</a>
        ...
        <div className="hidden md:flex items-center">
          <ul className="list-none flex dark:text-white gap-5 border-r-2 pe-5 me-5 border-gray-300 ">
            <li className="text-base cursor-pointer dark:hover:text-white text-[#4B5563] dark:text-[#E1E4E8] hover:text-black transition-all font-medium"><a href="#Skills">Skills</a></li>
            <li className="text-base cursor-pointer dark:hover:text-white text-[#4B5563] dark:text-[#E1E4E8] hover:text-black transition-all font-medium"><a href="#Experience">Experience</a></li>
            <li className="text-base cursor-pointer dark:hover:text-white  dark:text-[#E1E4E8] text-[#4B5563] hover:text-black transition-all font-medium"><a href="#work">Work</a></li>
            <li className="text-base cursor-pointer dark:hover:text-white  dark:text-[#E1E4E8] text-[#4B5563] hover:text-black transition-all font-medium"><a href="#Testimonials">Testimonials</a></li>
            <li className="text-base cursor-pointer dark:hover:text-white  dark:text-[#E1E4E8] text-[#4B5563] hover:text-black transition-all font-medium"><a href="#content">Content</a></li>
          </ul>
          <div>
      ...
      <section className="sidebar  z-50 fixed overflow-hidden backdrop-blur-[4px]  top-0 w-full h-screen">
        <div className="w-[70%] dark:bg-[#030712]  sm:max-w-[42%] ms-auto bg-white h-full ">
          ...
          <ul className="list-none p-5 border-b-1 dark:border-gray-700 border-gray-200">
            <li className="text-base cursor-pointer dark:text-[#D1D5DB]  text-[#4B5563] hover:text-black dark:hover:text-white  transition-all font-medium mb-3 "><a onClick={hideSide} href="#Skills">Skills</a></li>
            <li className="text-base cursor-pointer dark:text-[#D1D5DB]  text-[#4B5563] hover:text-black dark:hover:text-white  transition-all font-medium mb-3 "><a onClick={hideSide} href="#Experience">Experience</a></li>
            <li className="text-base cursor-pointer dark:text-[#D1D5DB] text-[#4B5563] hover:text-black dark:hover:text-white transition-all font-medium mb-3"><a onClick={hideSide} href="#work">Work</a></li>
            <li className="text-base cursor-pointer dark:text-[#D1D5DB] text-[#4B5563] hover:text-black dark:hover:text-white transition-all font-medium mb-3"><a onClick={hideSide} href="#Testimonials">Testimonials</a></li>
            <li className="text-base cursor-pointer dark:text-[#D1D5DB] dark:hover:text-white text-[#4B5563] hover:text-black transition-all font-medium mb-3"><a onClick={hideSide} href="#content">Content</a></li>
          </ul>
